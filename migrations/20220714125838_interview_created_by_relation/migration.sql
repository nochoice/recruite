...
CREATE TABLE "new_Interview" (
    ...
    CONSTRAINT "Interview_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Interview" ("canditate", "company", "createdAt", "createdBy", "date", "description", "id", "position", "title", "updatedAt", "updatedBy") SELECT "canditate", "company", "createdAt", "createdBy", "date", "description", "id", "position", "title", "updatedAt", "updatedBy" FROM "Interview";
...
CREATE INDEX "Interview_createdBy_idx" ON "Interview"("createdBy");
